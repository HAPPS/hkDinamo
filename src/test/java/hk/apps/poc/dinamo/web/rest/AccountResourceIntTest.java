package hk.apps.poc.dinamo.web.rest;

import hk.apps.poc.dinamo.config.Constants;
import hk.apps.poc.dinamo.HkDinamoApp;
import hk.apps.poc.dinamo.domain.Authority;
import hk.apps.poc.dinamo.domain.PersistentToken;
import hk.apps.poc.dinamo.domain.User;
import hk.apps.poc.dinamo.repository.AuthorityRepository;
import hk.apps.poc.dinamo.repository.PersistentTokenRepository;
import hk.apps.poc.dinamo.repository.UserRepository;
import hk.apps.poc.dinamo.security.AuthoritiesConstants;
import hk.apps.poc.dinamo.service.MailService;
import hk.apps.poc.dinamo.service.dto.UserDTO;
import hk.apps.poc.dinamo.web.rest.errors.ExceptionTranslator;
import hk.apps.poc.dinamo.web.rest.vm.KeyAndPasswordVM;
import hk.apps.poc.dinamo.web.rest.vm.ManagedUserVM;
import hk.apps.poc.dinamo.service.UserService;
...
@SpringBootTest(classes = HkDinamoApp.class)
