package hk.apps.poc.dinamo.config.social;

import hk.apps.poc.dinamo.repository.SocialUserConnectionRepository;
import hk.apps.poc.dinamo.repository.CustomSocialUsersConnectionRepository;
import hk.apps.poc.dinamo.security.social.CustomSignInAdapter;
